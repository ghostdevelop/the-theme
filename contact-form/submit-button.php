...
add_action( 'wpcf7_admin_init', 'wpcf7_custom_add_tag_generator_submit', 55 );

function wpcf7_custom_add_tag_generator_submit() {
	$tag_generator = WPCF7_TagGenerator::get_instance();
	$tag_generator->add( 'submit', __( 'submit', 'contact-form-7' ),
		'wpcf7_tag_generator_submit', array( 'nameless' => 1 ) );
}

function wpcf7_custom_tag_generator_submit( $contact_form, $args = '' ) {
